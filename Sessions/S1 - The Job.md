...
#### S1 - The Extended Family
- PCs would have gathered that meeting at the Hall of Tranquility happens infrequently. That Liang seems to be the host for such meetings, and it refers to a type of gathering, rather than a physical location.
- As the name implies, Kindred are to behave during such gatherings. The use of powers is frowned upon.
